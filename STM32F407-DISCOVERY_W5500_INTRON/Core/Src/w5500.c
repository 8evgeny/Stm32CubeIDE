...
void w5500_writeReg(uint8_t op, uint16_t addres, uint8_t data)
{
  ...
  SS_DESELECT();
      ...
      HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 34, 0x1000);
...
void w5500_writeBuf(data_sect_ptr *datasect, uint16_t len)
{
  ...
  HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 14, 0x1000);
  HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
}
//-----------------------------------------------
void w5500_writeSockBuf(uint8_t sock_num, uint16_t point, uint8_t *buf, uint16_t len)
{
  ...
  sprintf(tmp,"w5500_writeSockBuf");
  HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 18, 0x1000);
  HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
}
//-----------------------------------------------
...
uint8_t w5500_readSockBufByte(uint8_t sock_num, uint16_t point)
{
    ...
    HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 21, 0x1000);
    HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
...
void w5500_readSockBuf(uint8_t sock_num, uint16_t point, uint8_t *buf, uint16_t len)
{
    ...
    HAL_UART_Transmit(&huart6,(uint8_t *)tmp, strlen(tmp), 0x1000);
    HAL_UART_Transmit(&huart6,(uint8_t*)tmpbuf, len, 0x1000);
    HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
}
//-----------------------------------------------
void SetSockPort(uint8_t sock_num, uint16_t port)
{
  ...
  HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 24, 0x1000);
  HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
}
//-----------------------------------------------
void OpenSocket(uint8_t sock_num, uint16_t mode)
{
    ...
    HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 23, 0x1000);
    HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
}
//-----------------------------------------------
void SocketInitWait(uint8_t sock_num)
{
  ...
  HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 16, 0x1000);
  HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
...
void SocketListenWait(uint8_t sock_num)
{
  ...
  HAL_UART_Transmit(&huart6,(uint8_t *)tmp, 20, 0x1000);
  HAL_UART_Transmit(&huart6,"\r\n", 2, 0x1000);
