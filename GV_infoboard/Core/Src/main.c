...
/* USER CODE BEGIN Header_ledBlinker */
/**
* @brief Function implementing the ledBlinkerTask thread.
* @param argument: Not used
* @retval None
*/
...
void ledBlinker(void const * argument)
{
  ...
  /* USER CODE END ledBlinker */
}

/* USER CODE BEGIN Header_errorBlink */
/**
* @brief Function implementing the errorBlinkTask thread.
* @param argument: Not used
* @retval None
*/
...
void errorBlink(void const * argument)
{
  ...
  /* USER CODE END errorBlink */
}

/* USER CODE BEGIN Header_usbProceed */
/**
* @brief Function implementing the usbProcTask thread.
* @param argument: Not used
* @retval None
*/
