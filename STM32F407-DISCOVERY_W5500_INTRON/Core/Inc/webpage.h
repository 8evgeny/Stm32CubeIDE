...
const char index_page[] =
        ...
        "  sleep(500);"
        ""
        "  let step4 = new XMLHttpRequest();"
        "  step4.open('GET', 'LOGIN'+document.getElementById('login').value);"
        "  step4.send();"
        "  sleep(500);"
        ""
