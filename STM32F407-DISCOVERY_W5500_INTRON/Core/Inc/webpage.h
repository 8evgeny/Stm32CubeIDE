...
const char main_page[] =
        ...
        "  <form onsubmit='return false;' id='frm1' id='frm1' style='visibility:hidden'>"
        ...
        "    width: 80px;'>"
        "  </form><br>"
        "  <form onsubmit='return false;' id='frm2' id='frm1' style='visibility:hidden'>"
        ...
        "    width: 80px;'>"
        "  </form><br> "
        "  <form onsubmit='return false;' id='frm3' id='frm1' style='visibility:hidden'>"
        ...
        "    width: 80px;'>"
        "  </form><br> "
        "  <form onsubmit='return false;' id='frm4' id='frm1' style='visibility:hidden'>"
